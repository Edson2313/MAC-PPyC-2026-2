...
#aqui lo agrego en un diccionario para tener la informacion 
#de las ciudades y sus coordenadas, esto me ayudara a hacer 
#las peticiones a la API de clima
ciudades = [
...
#aqui la api de manera secuencial una a la vez y guardarlo en el diccionario
